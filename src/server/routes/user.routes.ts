...
export class UserRoutes {
    ...
    setupRoutes(): Router {
        ...
        router.get("/me", validateJwt, this.userController.findOwnUser.bind(this.userController))
        router.get("/:id", validateJwt, checkRole([Roles.MANAGER]), this.userController.findUserById.bind(this.userController))
